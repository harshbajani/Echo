...
const SYSTEM_PROMPTS = {
  image:
    "Your turn image into text . If it is a photo of a document, then transcribe it. If it is not a document describe it",
    ...
    messages: [
      {
        ...
        content: [
          {
            type: "text",
            text: `Extract the text from this PDF file: ${url}. The filename is ${filename}. Extract the text and print it without explaining you'll do so.`,
          },
        ],
      },
    ],
